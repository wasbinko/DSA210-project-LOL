...
* **Confusion Matrix Analysis:** * The model correctly identified 61.75% of outcomes. 
    * It is particularly accurate at identifying losses when the bot lane falls behind. 
...
Using **K-Means Clustering (k=4)**, bot lane duos were automatically categorized into tiers:
* **S-Tier (Dominant):** Win Rates **> 60%** and consistent positive gold leads. These are the "Meta Kings" (e.g., Jinx + Thresh).
